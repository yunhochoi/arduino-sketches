...
AccelStepper accelStepper(1,13,12);//initialise accelstepper for a two wire board, pin 5 step, pin 4 dir
...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    if (inByte == 'd') {  //direction, rectangle
     // enableAll();
      dir *= -1;
      Serial.print("d come");
    }
    if (inByte == 'f') {  //direction, particle
      //enableAll();
      dir2 *= -1;
      Serial.print("f come");
    }
...
//    accelStepper.setMaxSpeed(10000);
